import{j as r}from"./index-ff-h_orI.js";import"./helperFunctions-CVbg5pAE.js";import"./index-C1MLra31.js";import"./svelte/svelte.js";const e="iblIcdfPixelShader",t=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;r.ShadersStoreWGSL[e]||(r.ShadersStoreWGSL[e]=t);const o={name:e,shader:t};export{o as iblIcdfPixelShaderWGSL};
//# sourceMappingURL=iblIcdf.fragment-C3PhjfF1.js.map
