import{j as e}from"./index-ff-h_orI.js";const t="prePassDeclaration",w=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=w);const o="oitDeclaration",D=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=D);const i="decalFragmentDeclaration",X=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=X);const a="lightFragmentDeclaration",C=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=C);const r="lightUboDeclaration",x=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=x);const s="samplerFragmentDeclaration",L=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=L);const n="imageProcessingDeclaration",T=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=T);const l="imageProcessingFunctions",E=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=E);const d="shadowsFragmentFunctions",I=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=A);const c="bumpFragmentMainFunctions",P=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=P);const h="bumpFragmentFunctions",M=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=M);const v="reflectionFunction",F=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=F);const u="decalFragment",y=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=y);const p="bumpFragment",N=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=N);const m="depthPrePass",b=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=b);const S="lightFragment",O=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=O);const g="oitFragment",R=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=R);
//# sourceMappingURL=oitFragment-CXqO3-Hd.js.map
